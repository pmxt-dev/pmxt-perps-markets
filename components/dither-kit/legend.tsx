      ...
      {chart.names.map((name) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex items-center gap-1.5 font-mono text-[11px] text-oklch(0.556 0 0) transition-opacity dark:text-oklch(0.708 0 0)",
              isClickable &&
                "pointer-events-auto cursor-pointer hover:text-oklch(0.145 0 0) dark:hover:text-oklch(0.985 0 0)",
              dimmed && "opacity-40"
            )}
          >
            <span
